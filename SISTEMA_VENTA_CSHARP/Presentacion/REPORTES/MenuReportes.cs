...
namespace SISTEMA_VENTA_CSHARP.Presentacion.REPORTES
{
    public partial class MenuReportes : Form
    {
        ...
        private void imprimir_inventarios_todos()
        {
            ...
            REPORTE_DE_KARDEX.REPORTE_DE_INVENTARIOS_TODOS.ReportInventarios_Todos rpt = new REPORTE_DE_KARDEX.REPORTE_DE_INVENTARIOS_TODOS.ReportInventarios_Todos();
            rpt.table1.DataSource = dt;
            rpt.DataSource = dt;
        ...
        private void mostrar_productos_vencidos()
        {
            ...
            REPORTE_DE_KARDEX.REPORTE_DE_INVENTARIOS_TODOS.ReportePVencidos rpt = new REPORTE_DE_KARDEX.REPORTE_DE_INVENTARIOS_TODOS.ReportePVencidos();
            rpt.table1.DataSource = dt;
            rpt.DataSource = dt;
            ReportViewer3.Report = rpt;
            ReportViewer3.RefreshReport();
        ...
        private void mostrarProdctosMinimo()
        {
            ...
            REPORTE_DE_KARDEX.REPORTE_DE_INVENTARIOS_TODOS.ReportePbajomin rpt = new REPORTE_DE_KARDEX.REPORTE_DE_INVENTARIOS_TODOS.ReportePbajomin();
            rpt.table1.DataSource = dt;
            rpt.DataSource = dt;
            ReportViewer3.Report = rpt;
            ReportViewer3.RefreshReport();
