...
namespace SISTEMA_VENTA_CSHARP.Presentacion.VENTAS_MENU_PRINCIPAL
{
    public partial class MEDIOS_DE_PAGO : Form
    {
        ...
        {
            //btnGuardarImprimirdirecto.Text = "Guardar e Imprimir " + lblComprobante + " (Enter)";
            TXTVUELTO.Text = "0.0";
        ...
        {
            //añksbjdñalkjnsdkpfhabslkdna´{nnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnldnaLÑksdnfa{lsknf{kjadbflamnfñhvadjfna{ljbfoahb
        ...
        void buscarclientes2()
        {
            ...
            {
                CONEXION.CONEXIONMAESTRA.abrir();
                SqlDataAdapter da = new SqlDataAdapter("buscar_clientes_POR_nombre_PARA_VENTAS_todos", CONEXION.CONEXIONMAESTRA.conectar);
                da.SelectCommand.CommandType = CommandType.StoredProcedure;
        ...
        void insertar_cliente() 
        {
            ...
            {
                MessageBox.Show("POR FAVOR LLENAR EL CAMPO NOMBRE", "Datos Incompletos", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
            ...
            try
            {
                foreach (DataGridViewRow row in datalistadoDetalleVenta.Rows)
                {
                    ...
                    if (STOCK != "Ilimitado")
                    {
                        ...
                        cmd.Parameters.AddWithValue("@Estado", "VENTA CONFIRMADA");
