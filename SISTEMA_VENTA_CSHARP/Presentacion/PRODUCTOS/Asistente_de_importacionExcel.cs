    ...
    public partial class Asistente_de_importacionExcel : Form
    {
        ...
        {            
            try
            {
                ...
                {
                    ruta = folderBrowserDialog1.SelectedPath + "KyM-FARMA.xlsx";
        ...
        private void guardar_datos_Precargados()
        {
            ...
            try
            {
                foreach (DataGridViewRow row in datalistado.Rows)
                {
                    ...
                    cmd.Parameters.AddWithValue("@Contiene", 0);
                    ...
                    cmd.Parameters.AddWithValue("@Id_usuario", productosOK.idusuario);
